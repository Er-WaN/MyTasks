...
class TaskGatlingTest extends Simulation {
    ...
    val scn = scenario("Test the Task entity")
        ...
        .repeat(2) {
            ...
            .post("/api/tasks")
            .headers(headers_http_authenticated)
            .body(StringBody("""{"id":null, "name":"SAMPLE_TEXT", "creationDate":"2020-01-01T00:00:00.000Z", "lastEditDate":"2020-01-01T00:00:00.000Z", "finishDate":"2020-01-01T00:00:00.000Z", "priority":null, "complexity":null, "state":null, "estimatedTime":"0", "description":"SAMPLE_TEXT", "comment":"SAMPLE_TEXT"}""")).asJSON
            .check(status.is(201))
