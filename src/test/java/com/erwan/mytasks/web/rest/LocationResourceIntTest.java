...
public class LocationResourceIntTest {
    ...
    public void initTest() {
        ...
        location.setOutdoor(DEFAULT_OUTDOOR);
        location.setFloor(DEFAULT_FLOOR);
    }
    ...
    public void createLocation() throws Exception {
        ...
        assertThat(testLocation.getOutdoor()).isEqualTo(DEFAULT_OUTDOOR);
    ...
    public void updateLocation() throws Exception {
        ...
        location.setOutdoor(UPDATED_OUTDOOR);
        location.setFloor(UPDATED_FLOOR);
        LocationDTO locationDTO = locationMapper.locationToLocationDTO(location);
        ...
        assertThat(testLocation.getOutdoor()).isEqualTo(UPDATED_OUTDOOR);
